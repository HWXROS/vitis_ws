...
void kernel24(
  ...
  float v136[1536][384][1][1];	// L213
  #pragma HLS resource variable=v136 core=ram_t2p_bram

  memcpy(v136, v134, 589824 * sizeof(float));	// L214
    ...
    for (int v138 = 0; v138 < 1536; v138 += 1) {	// L216
      for (int v139 = 0; v139 < 8; v139 += 1) {	// L217
        for (int v140 = 0; v140 < 8; v140 += 1) {	// L218
          ...
          float v142 = v136[v138][v137][0][0];	// L220
...
void kernel41(
  ...
  float v222[384][384][1];	// L346
  #pragma HLS resource variable=v222 core=ram_t2p_bram

  memcpy(v222, v220, 147456 * sizeof(float));	// L347
  ...
  for (int v223 = 0; v223 < 384; v223 += 1) {	// L348
    for (int v224 = 0; v224 < 384; v224 += 1) {	// L349
      for (int v225 = 0; v225 < 64; v225 += 1) {	// L350
        ...
        float v227 = v222[v224][v223][0];	// L352
...
void kernel42(
  ...
  float v233[384];	// L363
  #pragma HLS resource variable=v233 core=ram_t2p_bram
...
void kernel60(
  ...
  float v323[1][12][64][64];	// L503
  #pragma HLS resource variable=v323 core=ram_t2p_bram

  memcpy(v323, v320, 49152 * sizeof(float));	// L504
    ...
    for (int v325 = 0; v325 < 12; v325 += 1) {	// L506
      for (int v326 = 0; v326 < 64; v326 += 1) {	// L507
        for (int v327 = 0; v327 < 32; v327 += 1) {	// L508
          ...
          float v328 = v323[0][v325][v326][v324];	// L509
...
void kernel63(
  ...
  float v348[1][12][64][32];	// L544
  #pragma HLS resource variable=v348 core=ram_t2p_bram

  memcpy(v348, v345, 24576 * sizeof(float));	// L545
    ...
    for (int v350 = 0; v350 < 12; v350 += 1) {	// L547
      for (int v351 = 0; v351 < 64; v351 += 1) {	// L548
        for (int v352 = 0; v352 < 64; v352 += 1) {	// L549
          ...
          float v353 = v348[0][v350][v351][v349];	// L550
...
void kernel83(
  ...
  float v441[384][384][1];	// L690
  #pragma HLS resource variable=v441 core=ram_t2p_bram

  memcpy(v441, v439, 147456 * sizeof(float));	// L691
  ...
  for (int v442 = 0; v442 < 384; v442 += 1) {	// L692
    for (int v443 = 0; v443 < 384; v443 += 1) {	// L693
      for (int v444 = 0; v444 < 64; v444 += 1) {	// L694
        ...
        float v446 = v441[v443][v442][0];	// L696
...
void kernel523(
  ...
  float v475[384][384][3][3];	// L749
  #pragma HLS resource variable=v475 core=ram_t2p_bram

  memcpy(v475, v473, 1327104 * sizeof(float));	// L750
        ...
        for (int v479 = 0; v479 < 384; v479 += 1) {	// L754
          for (int v480 = 0; v480 < 8; v480 += 1) {	// L755
            for (int v481 = 0; v481 < 8; v481 += 1) {	// L756
              ...
              float v483 = v475[v479][v476][v477][v478];	// L758
...
void kernel545(
  ...
  float v593[384][192][3][3];	// L942
  #pragma HLS resource variable=v593 core=ram_t2p_bram

  memcpy(v593, v591, 663552 * sizeof(float));	// L943
        ...
        for (int v597 = 0; v597 < 384; v597 += 1) {	// L947
          for (int v598 = 0; v598 < 16; v598 += 1) {	// L948
            for (int v599 = 0; v599 < 16; v599 += 1) {	// L949
              ...
              float v601 = v593[v597][v594][v595][v596];	// L951
...
void kernel567(
  ...
  float v718[192][96][3][3];	// L1148
  #pragma HLS resource variable=v718 core=ram_t2p_bram

  memcpy(v718, v716, 165888 * sizeof(float));	// L1149
        ...
        for (int v722 = 0; v722 < 192; v722 += 1) {	// L1153
          for (int v723 = 0; v723 < 32; v723 += 1) {	// L1154
            for (int v724 = 0; v724 < 32; v724 += 1) {	// L1155
              ...
              float v726 = v718[v722][v719][v720][v721];	// L1157
...
void kernel585(
  ...
  float v816[96][48][3][3];	// L1306
  #pragma HLS resource variable=v816 core=ram_t2p_bram

  memcpy(v816, v814, 41472 * sizeof(float));	// L1307
        ...
        for (int v820 = 0; v820 < 96; v820 += 1) {	// L1311
          for (int v821 = 0; v821 < 32; v821 += 1) {	// L1312
            for (int v822 = 0; v822 < 32; v822 += 1) {	// L1313
              ...
              float v824 = v816[v820][v817][v818][v819];	// L1315
...
void kernel586(
  ...
  float v830[96];	// L1329
  #pragma HLS resource variable=v830 core=ram_t2p_bram
...
void kernel604(
  ...
  float v928[48];	// L1487
  #pragma HLS resource variable=v928 core=ram_t2p_bram
