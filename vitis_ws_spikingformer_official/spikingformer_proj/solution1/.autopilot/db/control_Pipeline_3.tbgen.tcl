set moduleName control_Pipeline_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v928 { MEM_WIDTH 32 MEM_SIZE 192 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 0 stable }  }
	{ sext_ln2263 int 62 regular  }
	{ v928 float 32 regular {array 48 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln2263", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v928", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln2263 sc_in sc_lv 62 signal 1 } 
	{ v928_address0 sc_out sc_lv 6 signal 2 } 
	{ v928_ce0 sc_out sc_logic 1 signal 2 } 
	{ v928_we0 sc_out sc_logic 1 signal 2 } 
	{ v928_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2263", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2263", "role": "default" }} , 
 	{ "name": "v928_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v928", "role": "address0" }} , 
 	{ "name": "v928_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v928", "role": "ce0" }} , 
 	{ "name": "v928_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v928", "role": "we0" }} , 
 	{ "name": "v928_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v928", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln2263 { ap_none {  { sext_ln2263 in_data 0 62 } } }
	v928 { ap_memory {  { v928_address0 mem_address 1 6 }  { v928_ce0 mem_ce 1 1 }  { v928_we0 mem_we 1 1 }  { v928_d0 mem_din 1 32 } } }
}
