set moduleName control_Pipeline_VITIS_LOOP_1172_5_VITIS_LOOP_1173_6
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1172_5_VITIS_LOOP_1173_6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2299 int 62 regular  }
	{ sext_ln1877 int 62 regular  }
	{ sext_ln1177 int 62 regular  }
	{ zext_ln1169_1 int 2 regular  }
	{ phi_mul15319 int 16 regular  }
	{ v478 int 2 regular  }
	{ v944 int 64 regular  }
	{ zext_ln1172 int 17 regular  }
	{ v992 int 64 regular  }
	{ v483 float 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln1877", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln1177", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1169_1", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul15319", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "v478", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "v944", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1172", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v992", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v483", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln1877 sc_in sc_lv 62 signal 2 } 
	{ sext_ln1177 sc_in sc_lv 62 signal 3 } 
	{ zext_ln1169_1 sc_in sc_lv 2 signal 4 } 
	{ phi_mul15319 sc_in sc_lv 16 signal 5 } 
	{ v478 sc_in sc_lv 2 signal 6 } 
	{ v944 sc_in sc_lv 64 signal 7 } 
	{ zext_ln1172 sc_in sc_lv 17 signal 8 } 
	{ v992 sc_in sc_lv 64 signal 9 } 
	{ v483 sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1877", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1877", "role": "default" }} , 
 	{ "name": "sext_ln1177", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1177", "role": "default" }} , 
 	{ "name": "zext_ln1169_1", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln1169_1", "role": "default" }} , 
 	{ "name": "phi_mul15319", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "phi_mul15319", "role": "default" }} , 
 	{ "name": "v478", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "v478", "role": "default" }} , 
 	{ "name": "v944", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v944", "role": "default" }} , 
 	{ "name": "zext_ln1172", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln1172", "role": "default" }} , 
 	{ "name": "v992", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v992", "role": "default" }} , 
 	{ "name": "v483", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v483", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1877 { ap_none {  { sext_ln1877 in_data 0 62 } } }
	sext_ln1177 { ap_none {  { sext_ln1177 in_data 0 62 } } }
	zext_ln1169_1 { ap_none {  { zext_ln1169_1 in_data 0 2 } } }
	phi_mul15319 { ap_none {  { phi_mul15319 in_data 0 16 } } }
	v478 { ap_none {  { v478 in_data 0 2 } } }
	v944 { ap_none {  { v944 in_data 0 64 } } }
	zext_ln1172 { ap_none {  { zext_ln1172 in_data 0 17 } } }
	v992 { ap_none {  { v992 in_data 0 64 } } }
	v483 { ap_none {  { v483 in_data 0 32 } } }
}
