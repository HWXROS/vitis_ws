set moduleName kernel9_Pipeline_VITIS_LOOP_173_1_VITIS_LOOP_174_2_VITIS_LOOP_175_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel9_Pipeline_VITIS_LOOP_173_1_VITIS_LOOP_174_2_VITIS_LOOP_175_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v63 { MEM_WIDTH 32 MEM_SIZE 1536 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 1 stable }  }
	{ sext_ln173 int 62 regular  }
	{ v63 float 32 regular {array 384 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln173", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v63", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln173", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln173", "role": "default" }} , 
 	...
 	{ "name": "v63_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v63", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln173 { ap_none {  { sext_ln173 in_data 0 62 } } }
	v63 { ap_memory {  { v63_address0 mem_address 1 9 }  { v63_ce0 mem_ce 1 1 }  { v63_q0 mem_dout 0 32 } } }
}
