set moduleName control_Pipeline_VITIS_LOOP_42_1_VITIS_LOOP_43_2
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_42_1_VITIS_LOOP_43_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v9 { MEM_WIDTH 32 MEM_SIZE 1536 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2027 int 62 regular  }
	{ sext_ln62 int 62 regular  }
	{ v9 float 32 regular {array 384 { 1 3 } 1 1 }  }
	{ sext_ln2027_1 int 62 regular  }
	{ v1162 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "v9", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2027_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v1162", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2027 sc_in sc_lv 62 signal 1 } 
	{ sext_ln62 sc_in sc_lv 62 signal 2 } 
	{ v9_address0 sc_out sc_lv 9 signal 3 } 
	{ v9_ce0 sc_out sc_logic 1 signal 3 } 
	{ v9_q0 sc_in sc_lv 32 signal 3 } 
	{ sext_ln2027_1 sc_in sc_lv 62 signal 4 } 
	{ v1162 sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v9_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "v9", "role": "address0" }} , 
 	{ "name": "v9_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v9", "role": "ce0" }} , 
 	{ "name": "v9_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v9", "role": "q0" }} , 
 	{ "name": "sext_ln2027_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2027_1", "role": "default" }} , 
 	{ "name": "v1162", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1162", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7702", "Max" : "7702"}
...
set Spec2ImplPortList { 
	...
	v9 { ap_memory {  { v9_address0 mem_address 1 9 }  { v9_ce0 mem_ce 1 1 }  { v9_q0 mem_dout 0 32 } } }
	sext_ln2027_1 { ap_none {  { sext_ln2027_1 in_data 0 62 } } }
	v1162 { ap_none {  { v1162 in_data 0 64 } } }
}
