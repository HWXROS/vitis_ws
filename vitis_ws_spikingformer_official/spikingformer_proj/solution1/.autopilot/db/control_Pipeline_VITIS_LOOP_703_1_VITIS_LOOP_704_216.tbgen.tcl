set moduleName control_Pipeline_VITIS_LOOP_703_1_VITIS_LOOP_704_216
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_703_1_VITIS_LOOP_704_216}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln703_2 int 62 regular  }
	{ sext_ln615 int 62 regular  }
	{ sext_ln736 int 62 regular  }
	{ sext_ln703_7 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln615", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln736", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln703_7", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln703_2 sc_in sc_lv 62 signal 1 } 
	{ sext_ln615 sc_in sc_lv 62 signal 2 } 
	{ sext_ln736 sc_in sc_lv 62 signal 3 } 
	{ sext_ln703_7 sc_in sc_lv 62 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln615", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln615", "role": "default" }} , 
 	{ "name": "sext_ln736", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln736", "role": "default" }} , 
 	{ "name": "sext_ln703_7", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln703_7", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln615 { ap_none {  { sext_ln615 in_data 0 62 } } }
	sext_ln736 { ap_none {  { sext_ln736 in_data 0 62 } } }
	sext_ln703_7 { ap_none {  { sext_ln703_7 in_data 0 62 } } }
