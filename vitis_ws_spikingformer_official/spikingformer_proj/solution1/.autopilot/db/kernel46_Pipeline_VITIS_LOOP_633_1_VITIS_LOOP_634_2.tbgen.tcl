set moduleName kernel46_Pipeline_VITIS_LOOP_633_1_VITIS_LOOP_634_2
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel46_Pipeline_VITIS_LOOP_633_1_VITIS_LOOP_634_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln636 int 62 regular  }
	{ sext_ln633 int 62 regular  }
	{ sext_ln638 int 62 regular  }
	{ v255 int 64 regular  }
	{ v254 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln633", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln638", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v255", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v254", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln636 sc_in sc_lv 62 signal 1 } 
	{ sext_ln633 sc_in sc_lv 62 signal 2 } 
	{ sext_ln638 sc_in sc_lv 62 signal 3 } 
	{ v255 sc_in sc_lv 64 signal 4 } 
	{ v254 sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln633", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln633", "role": "default" }} , 
 	{ "name": "sext_ln638", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln638", "role": "default" }} , 
 	{ "name": "v255", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v255", "role": "default" }} , 
 	{ "name": "v254", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v254", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln633 { ap_none {  { sext_ln633 in_data 0 62 } } }
	sext_ln638 { ap_none {  { sext_ln638 in_data 0 62 } } }
	v255 { ap_none {  { v255 in_data 0 64 } } }
	v254 { ap_none {  { v254 in_data 0 64 } } }
}
