set moduleName control_Pipeline_VITIS_LOOP_2233_1_VITIS_LOOP_2234_2_VITIS_LOOP_2235_3_VITIS_LOO
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_2233_1_VITIS_LOOP_2234_2_VITIS_LOOP_2235_3_VITIS_LOO}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v914 { MEM_WIDTH 32 MEM_SIZE 5184 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2299 int 62 regular  }
	{ sext_ln2265 int 62 regular  }
	{ v914 float 32 regular {array 1296 { 1 3 } 1 1 }  }
	{ v944 int 64 regular  }
	{ v949 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "v914", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v914_address0 sc_out sc_lv 11 signal 3 } 
	{ v914_ce0 sc_out sc_logic 1 signal 3 } 
	{ v914_q0 sc_in sc_lv 32 signal 3 } 
	{ v944 sc_in sc_lv 64 signal 4 } 
	{ v949 sc_in sc_lv 64 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v914_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "v914", "role": "address0" }} , 
 	{ "name": "v914_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v914", "role": "ce0" }} , 
 	{ "name": "v914_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v914", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2654231", "Max" : "2654231"}
	, {"Name" : "Interval", "Min" : "2654210", "Max" : "2654210"}
]}
...
set Spec2ImplPortList { 
	...
	v914 { ap_memory {  { v914_address0 mem_address 1 11 }  { v914_ce0 mem_ce 1 1 }  { v914_q0 mem_dout 0 32 } } }
