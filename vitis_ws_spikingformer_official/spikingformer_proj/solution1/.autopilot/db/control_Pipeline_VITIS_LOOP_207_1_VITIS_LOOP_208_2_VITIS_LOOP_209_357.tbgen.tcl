set moduleName control_Pipeline_VITIS_LOOP_207_1_VITIS_LOOP_208_2_VITIS_LOOP_209_357
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_207_1_VITIS_LOOP_208_2_VITIS_LOOP_209_357}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln703_4 int 62 regular  }
	{ sext_ln2159 int 62 regular  }
	{ sext_ln703_9 int 62 regular  }
	{ v1050 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln2159", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln703_9", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v1050", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln703_4 sc_in sc_lv 62 signal 1 } 
	{ sext_ln2159 sc_in sc_lv 62 signal 2 } 
	{ sext_ln703_9 sc_in sc_lv 62 signal 3 } 
	{ v1050 sc_in sc_lv 64 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2159", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2159", "role": "default" }} , 
 	{ "name": "sext_ln703_9", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln703_9", "role": "default" }} , 
 	{ "name": "v1050", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1050", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln2159 { ap_none {  { sext_ln2159 in_data 0 62 } } }
	sext_ln703_9 { ap_none {  { sext_ln703_9 in_data 0 62 } } }
	v1050 { ap_none {  { v1050 in_data 0 64 } } }
}
