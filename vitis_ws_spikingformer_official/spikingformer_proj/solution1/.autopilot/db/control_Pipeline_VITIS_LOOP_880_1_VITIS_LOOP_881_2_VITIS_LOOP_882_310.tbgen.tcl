set moduleName control_Pipeline_VITIS_LOOP_880_1_VITIS_LOOP_881_2_VITIS_LOOP_882_310
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_880_1_VITIS_LOOP_881_2_VITIS_LOOP_882_310}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln897_1 int 62 regular  }
	{ sext_ln880 int 62 regular  }
	{ v944 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln897_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln880", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln897_1 sc_in sc_lv 62 signal 1 } 
	{ sext_ln880 sc_in sc_lv 62 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln897_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln897_1", "role": "default" }} , 
 	{ "name": "sext_ln880", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln880", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln897_1 { ap_none {  { sext_ln897_1 in_data 0 62 } } }
	sext_ln880 { ap_none {  { sext_ln880 in_data 0 62 } } }
