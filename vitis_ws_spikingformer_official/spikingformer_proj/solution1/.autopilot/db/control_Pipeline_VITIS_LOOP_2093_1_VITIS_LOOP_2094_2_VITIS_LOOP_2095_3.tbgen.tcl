set moduleName control_Pipeline_VITIS_LOOP_2093_1_VITIS_LOOP_2094_2_VITIS_LOOP_2095_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_2093_1_VITIS_LOOP_2094_2_VITIS_LOOP_2095_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "v1159", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2299 sc_in sc_lv 62 signal 2 } 
	{ sext_ln2113_3 sc_in sc_lv 62 signal 3 } 
	{ v1159 sc_in sc_lv 64 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v1159", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1159", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98324", "Max" : "98324"}
...
set Spec2ImplPortList { 
	...
	v1159 { ap_none {  { v1159 in_data 0 64 } } }
}
