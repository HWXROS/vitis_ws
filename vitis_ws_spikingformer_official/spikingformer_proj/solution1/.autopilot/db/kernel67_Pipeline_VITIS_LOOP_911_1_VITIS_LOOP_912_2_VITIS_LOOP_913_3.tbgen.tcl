set moduleName kernel67_Pipeline_VITIS_LOOP_911_1_VITIS_LOOP_912_2_VITIS_LOOP_913_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel67_Pipeline_VITIS_LOOP_911_1_VITIS_LOOP_912_2_VITIS_LOOP_913_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln915 int 62 regular  }
	{ sext_ln911 int 62 regular  }
	{ v370 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln915", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln911", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v370", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln915 sc_in sc_lv 62 signal 1 } 
	{ sext_ln911 sc_in sc_lv 62 signal 2 } 
	{ v370 sc_in sc_lv 64 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln915", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln915", "role": "default" }} , 
 	{ "name": "sext_ln911", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln911", "role": "default" }} , 
 	{ "name": "v370", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v370", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24587", "Max" : "24587"}
...
set Spec2ImplPortList { 
	...
	sext_ln915 { ap_none {  { sext_ln915 in_data 0 62 } } }
	sext_ln911 { ap_none {  { sext_ln911 in_data 0 62 } } }
	v370 { ap_none {  { v370 in_data 0 64 } } }
}
