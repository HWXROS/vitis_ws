set moduleName kernel41_Pipeline_VITIS_LOOP_549_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel41_Pipeline_VITIS_LOOP_549_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln551 int 62 regular  }
	{ sext_ln552 int 62 regular  }
	{ sext_ln553 int 62 regular  }
	{ v219 int 64 regular  }
	{ zext_ln548 int 17 regular  }
	{ v221 int 64 regular  }
	{ zext_ln549 int 17 regular  }
	{ v227 float 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln552", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln553", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v219", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln548", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v221", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln549", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v227", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln551 sc_in sc_lv 62 signal 1 } 
	{ sext_ln552 sc_in sc_lv 62 signal 2 } 
	{ sext_ln553 sc_in sc_lv 62 signal 3 } 
	{ v219 sc_in sc_lv 64 signal 4 } 
	{ zext_ln548 sc_in sc_lv 17 signal 5 } 
	{ v221 sc_in sc_lv 64 signal 6 } 
	{ zext_ln549 sc_in sc_lv 17 signal 7 } 
	{ v227 sc_in sc_lv 32 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln552", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln552", "role": "default" }} , 
 	{ "name": "sext_ln553", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln553", "role": "default" }} , 
 	{ "name": "v219", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v219", "role": "default" }} , 
 	{ "name": "zext_ln548", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln548", "role": "default" }} , 
 	{ "name": "v221", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v221", "role": "default" }} , 
 	{ "name": "zext_ln549", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln549", "role": "default" }} , 
 	{ "name": "v227", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v227", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln552 { ap_none {  { sext_ln552 in_data 0 62 } } }
	sext_ln553 { ap_none {  { sext_ln553 in_data 0 62 } } }
	v219 { ap_none {  { v219 in_data 0 64 } } }
	zext_ln548 { ap_none {  { zext_ln548 in_data 0 17 } } }
	v221 { ap_none {  { v221 in_data 0 64 } } }
	zext_ln549 { ap_none {  { zext_ln549 in_data 0 17 } } }
	v227 { ap_none {  { v227 in_data 0 32 } } }
}
