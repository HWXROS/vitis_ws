set moduleName control_Pipeline_VITIS_LOOP_1484_1_VITIS_LOOP_1485_2_VITIS_LOOP_1486_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1484_1_VITIS_LOOP_1485_2_VITIS_LOOP_1486_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v607 { MEM_WIDTH 32 MEM_SIZE 1536 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 1 stable }  }
	{ sext_ln2265 int 62 regular  }
	{ v607 float 32 regular {array 384 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "v607", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ v607_address0 sc_out sc_lv 9 signal 2 } 
	{ v607_ce0 sc_out sc_logic 1 signal 2 } 
	{ v607_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v607_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "v607", "role": "address0" }} , 
 	{ "name": "v607_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v607", "role": "ce0" }} , 
 	{ "name": "v607_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v607", "role": "q0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98307", "Max" : "98307"}
...
set Spec2ImplPortList { 
	...
	v607 { ap_memory {  { v607_address0 mem_address 1 9 }  { v607_ce0 mem_ce 1 1 }  { v607_q0 mem_dout 0 32 } } }
}
