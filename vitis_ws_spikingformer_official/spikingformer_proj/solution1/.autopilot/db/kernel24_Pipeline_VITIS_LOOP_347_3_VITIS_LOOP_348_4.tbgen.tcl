set moduleName kernel24_Pipeline_VITIS_LOOP_347_3_VITIS_LOOP_348_4
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel24_Pipeline_VITIS_LOOP_347_3_VITIS_LOOP_348_4}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln350 int 62 regular  }
	{ sext_ln351 int 62 regular  }
	{ sext_ln352 int 62 regular  }
	{ zext_ln346 int 17 regular  }
	{ v133 int 64 regular  }
	{ zext_ln347 int 19 regular  }
	{ v135 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln350", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln351", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln352", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln346", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v133", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln347", "interface" : "wire", "bitwidth" : 19, "direction" : "READONLY"} , 
 	{ "Name" : "v135", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln350 sc_in sc_lv 62 signal 1 } 
	{ sext_ln351 sc_in sc_lv 62 signal 2 } 
	{ sext_ln352 sc_in sc_lv 62 signal 3 } 
	{ zext_ln346 sc_in sc_lv 17 signal 4 } 
	{ v133 sc_in sc_lv 64 signal 5 } 
	{ zext_ln347 sc_in sc_lv 19 signal 6 } 
	{ v135 sc_in sc_lv 64 signal 7 } 
	{ v142 sc_in sc_lv 32 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln350", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln350", "role": "default" }} , 
 	{ "name": "sext_ln351", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln351", "role": "default" }} , 
 	{ "name": "sext_ln352", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln352", "role": "default" }} , 
 	{ "name": "zext_ln346", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln346", "role": "default" }} , 
 	{ "name": "v133", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v133", "role": "default" }} , 
 	{ "name": "zext_ln347", "direction": "in", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "zext_ln347", "role": "default" }} , 
 	{ "name": "v135", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v135", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln350 { ap_none {  { sext_ln350 in_data 0 62 } } }
	sext_ln351 { ap_none {  { sext_ln351 in_data 0 62 } } }
	sext_ln352 { ap_none {  { sext_ln352 in_data 0 62 } } }
	zext_ln346 { ap_none {  { zext_ln346 in_data 0 17 } } }
	v133 { ap_none {  { v133 in_data 0 64 } } }
	zext_ln347 { ap_none {  { zext_ln347 in_data 0 19 } } }
	v135 { ap_none {  { v135 in_data 0 64 } } }
