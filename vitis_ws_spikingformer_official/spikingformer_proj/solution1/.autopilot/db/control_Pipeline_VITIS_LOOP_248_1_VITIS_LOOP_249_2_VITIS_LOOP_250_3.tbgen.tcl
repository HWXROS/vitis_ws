set moduleName control_Pipeline_VITIS_LOOP_248_1_VITIS_LOOP_249_2_VITIS_LOOP_250_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_248_1_VITIS_LOOP_249_2_VITIS_LOOP_250_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2159 int 62 regular  }
	{ sext_ln703_1 int 62 regular  }
	{ v1050 int 64 regular  }
	{ sext_ln703_6 int 62 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln703_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v1050", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln703_6", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2159 sc_in sc_lv 62 signal 1 } 
	{ sext_ln703_1 sc_in sc_lv 62 signal 2 } 
	{ v1050 sc_in sc_lv 64 signal 3 } 
	{ sext_ln703_6 sc_in sc_lv 62 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln703_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln703_1", "role": "default" }} , 
 	{ "name": "v1050", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1050", "role": "default" }} , 
 	{ "name": "sext_ln703_6", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln703_6", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln703_1 { ap_none {  { sext_ln703_1 in_data 0 62 } } }
	v1050 { ap_none {  { v1050 in_data 0 64 } } }
	sext_ln703_6 { ap_none {  { sext_ln703_6 in_data 0 62 } } }
}
