set moduleName kernel8_Pipeline_VITIS_LOOP_147_3_VITIS_LOOP_148_4
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel8_Pipeline_VITIS_LOOP_147_3_VITIS_LOOP_148_4}
...
set C_modelArgList {
	...
	{ zext_ln147_1 int 17 regular  }
	{ v50 int 64 regular  }
	{ v57 float 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "zext_ln147_1", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v50", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v57", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln151 sc_in sc_lv 62 signal 2 } 
	{ sext_ln152 sc_in sc_lv 62 signal 3 } 
	{ sext_ln146 sc_in sc_lv 62 signal 4 } 
	{ zext_ln147_1 sc_in sc_lv 17 signal 5 } 
	{ v50 sc_in sc_lv 64 signal 6 } 
	{ v57 sc_in sc_lv 32 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln147_1", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "zext_ln147_1", "role": "default" }} , 
 	{ "name": "v50", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v50", "role": "default" }} , 
 	{ "name": "v57", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v57", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	zext_ln147_1 { ap_none {  { zext_ln147_1 in_data 0 17 } } }
	v50 { ap_none {  { v50 in_data 0 64 } } }
	v57 { ap_none {  { v57 in_data 0 32 } } }
}
