set moduleName control_Pipeline_VITIS_LOOP_703_1_VITIS_LOOP_704_233
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_703_1_VITIS_LOOP_704_233}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ v1057 int 64 regular  }
	{ sext_ln736_1 int 62 regular  }
	{ sext_ln703_2 int 62 regular  }
	{ sext_ln273 int 62 regular  }
	{ sext_ln736 int 62 regular  }
	{ v1117 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "v1057", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln736_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln703_2", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln273", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln736", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v1117", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ v1057 sc_in sc_lv 64 signal 1 } 
	{ sext_ln736_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln703_2 sc_in sc_lv 62 signal 3 } 
	{ sext_ln273 sc_in sc_lv 62 signal 4 } 
	{ sext_ln736 sc_in sc_lv 62 signal 5 } 
	{ v1117 sc_in sc_lv 64 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v1057", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1057", "role": "default" }} , 
 	{ "name": "sext_ln736_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln736_1", "role": "default" }} , 
 	{ "name": "sext_ln703_2", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln703_2", "role": "default" }} , 
 	{ "name": "sext_ln273", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln273", "role": "default" }} , 
 	{ "name": "sext_ln736", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln736", "role": "default" }} , 
 	{ "name": "v1117", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1117", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49172", "Max" : "49172"}
...
set Spec2ImplPortList { 
	...
	v1057 { ap_none {  { v1057 in_data 0 64 } } }
	sext_ln736_1 { ap_none {  { sext_ln736_1 in_data 0 62 } } }
	sext_ln703_2 { ap_none {  { sext_ln703_2 in_data 0 62 } } }
	sext_ln273 { ap_none {  { sext_ln273 in_data 0 62 } } }
	sext_ln736 { ap_none {  { sext_ln736 in_data 0 62 } } }
	v1117 { ap_none {  { v1117 in_data 0 64 } } }
}
