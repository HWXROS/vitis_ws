set moduleName control_Pipeline_VITIS_LOOP_1334_1_VITIS_LOOP_1335_2_VITIS_LOOP_1336_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1334_1_VITIS_LOOP_1335_2_VITIS_LOOP_1336_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln1334 int 62 regular  }
	{ sext_ln2113_1 int 62 regular  }
	{ sext_ln2061 int 62 regular  }
	{ sext_ln1334_1 int 62 regular  }
	{ sext_ln2061_1 int 62 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln1334", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2113_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2061", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln1334_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2061_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln1334 sc_in sc_lv 62 signal 1 } 
	{ sext_ln2113_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln2061 sc_in sc_lv 62 signal 3 } 
	{ sext_ln1334_1 sc_in sc_lv 62 signal 4 } 
	{ sext_ln2061_1 sc_in sc_lv 62 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1334", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1334", "role": "default" }} , 
 	{ "name": "sext_ln2113_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2113_1", "role": "default" }} , 
 	{ "name": "sext_ln2061", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2061", "role": "default" }} , 
 	{ "name": "sext_ln1334_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1334_1", "role": "default" }} , 
 	{ "name": "sext_ln2061_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2061_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "196623", "Max" : "196623"}
	, {"Name" : "Interval", "Min" : "196610", "Max" : "196610"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1334 { ap_none {  { sext_ln1334 in_data 0 62 } } }
	sext_ln2113_1 { ap_none {  { sext_ln2113_1 in_data 0 62 } } }
	sext_ln2061 { ap_none {  { sext_ln2061 in_data 0 62 } } }
	sext_ln1334_1 { ap_none {  { sext_ln1334_1 in_data 0 62 } } }
	sext_ln2061_1 { ap_none {  { sext_ln2061_1 in_data 0 62 } } }
}
