set moduleName kernel25_Pipeline_VITIS_LOOP_373_1_VITIS_LOOP_374_2_VITIS_LOOP_375_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {kernel25_Pipeline_VITIS_LOOP_373_1_VITIS_LOOP_374_2_VITIS_LOOP_375_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict v148 { MEM_WIDTH 32 MEM_SIZE 6144 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ g0 int 32 regular {axi_master 1 stable }  }
	{ sext_ln373 int 62 regular  }
	{ v148 float 32 regular {array 1536 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln373", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "v148", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln373 sc_in sc_lv 62 signal 1 } 
	{ v148_address0 sc_out sc_lv 11 signal 2 } 
	{ v148_ce0 sc_out sc_logic 1 signal 2 } 
	{ v148_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln373", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln373", "role": "default" }} , 
 	{ "name": "v148_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "v148", "role": "address0" }} , 
 	{ "name": "v148_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v148", "role": "ce0" }} , 
 	{ "name": "v148_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v148", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln373 { ap_none {  { sext_ln373 in_data 0 62 } } }
	v148 { ap_memory {  { v148_address0 mem_address 1 11 }  { v148_ce0 mem_ce 1 1 }  { v148_q0 mem_dout 0 32 } } }
}
