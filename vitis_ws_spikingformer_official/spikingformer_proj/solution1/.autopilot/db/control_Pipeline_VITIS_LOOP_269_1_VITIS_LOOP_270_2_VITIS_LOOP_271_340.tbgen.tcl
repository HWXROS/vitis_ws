set moduleName control_Pipeline_VITIS_LOOP_269_1_VITIS_LOOP_270_2_VITIS_LOOP_271_340
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_269_1_VITIS_LOOP_270_2_VITIS_LOOP_271_340}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln703_1 int 62 regular  }
	{ v1046 int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "v1046", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln703_1 sc_in sc_lv 62 signal 1 } 
	{ v1046 sc_in sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v1046", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v1046", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98322", "Max" : "98322"}
	, {"Name" : "Interval", "Min" : "98305", "Max" : "98305"}
]}
...
set Spec2ImplPortList { 
	...
	v1046 { ap_none {  { v1046 in_data 0 64 } } }
}
