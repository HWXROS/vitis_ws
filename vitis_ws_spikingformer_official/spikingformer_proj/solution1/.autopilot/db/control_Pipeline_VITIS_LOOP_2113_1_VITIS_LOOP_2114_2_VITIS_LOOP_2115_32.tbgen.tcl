set moduleName control_Pipeline_VITIS_LOOP_2113_1_VITIS_LOOP_2114_2_VITIS_LOOP_2115_32
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_2113_1_VITIS_LOOP_2114_2_VITIS_LOOP_2115_32}
...
set C_modelArgList {
	...
	{ sext_ln2265_1 int 62 regular  }
	{ sext_ln2299_1 int 62 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln2265_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2299_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2265 sc_in sc_lv 62 signal 1 } 
	{ sext_ln2113_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln2299 sc_in sc_lv 62 signal 3 } 
	{ sext_ln2265_1 sc_in sc_lv 62 signal 4 } 
	{ sext_ln2299_1 sc_in sc_lv 62 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2265_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2265_1", "role": "default" }} , 
 	{ "name": "sext_ln2299_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2299_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98319", "Max" : "98319"}
	, {"Name" : "Interval", "Min" : "98306", "Max" : "98306"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln2265_1 { ap_none {  { sext_ln2265_1 in_data 0 62 } } }
	sext_ln2299_1 { ap_none {  { sext_ln2299_1 in_data 0 62 } } }
}
