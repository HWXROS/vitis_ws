set moduleName control_Pipeline_VITIS_LOOP_1456_5_VITIS_LOOP_1457_6
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1456_5_VITIS_LOOP_1457_6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2299 int 62 regular  }
	{ sext_ln2265 int 62 regular  }
	{ sext_ln1461 int 62 regular  }
	{ zext_ln1453_1 int 2 regular  }
	{ phi_mul15231 int 16 regular  }
	{ v596 int 2 regular  }
	{ v944 int 64 regular  }
	{ zext_ln1456 int 19 regular  }
	{ v949 int 64 regular  }
	{ v601 float 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln2299", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln2265", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln1461", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1453_1", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul15231", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "v596", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "v944", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1456", "interface" : "wire", "bitwidth" : 19, "direction" : "READONLY"} , 
 	{ "Name" : "v949", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v601", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2299 sc_in sc_lv 62 signal 1 } 
	{ sext_ln2265 sc_in sc_lv 62 signal 2 } 
	{ sext_ln1461 sc_in sc_lv 62 signal 3 } 
	{ zext_ln1453_1 sc_in sc_lv 2 signal 4 } 
	{ phi_mul15231 sc_in sc_lv 16 signal 5 } 
	{ v596 sc_in sc_lv 2 signal 6 } 
	{ v944 sc_in sc_lv 64 signal 7 } 
	{ zext_ln1456 sc_in sc_lv 19 signal 8 } 
	{ v949 sc_in sc_lv 64 signal 9 } 
	{ v601 sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2299", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2299", "role": "default" }} , 
 	{ "name": "sext_ln2265", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2265", "role": "default" }} , 
 	{ "name": "sext_ln1461", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1461", "role": "default" }} , 
 	{ "name": "zext_ln1453_1", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln1453_1", "role": "default" }} , 
 	{ "name": "phi_mul15231", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "phi_mul15231", "role": "default" }} , 
 	{ "name": "v596", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "v596", "role": "default" }} , 
 	{ "name": "v944", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v944", "role": "default" }} , 
 	{ "name": "zext_ln1456", "direction": "in", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "zext_ln1456", "role": "default" }} , 
 	{ "name": "v949", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v949", "role": "default" }} , 
 	{ "name": "v601", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v601", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln2299 { ap_none {  { sext_ln2299 in_data 0 62 } } }
	sext_ln2265 { ap_none {  { sext_ln2265 in_data 0 62 } } }
	sext_ln1461 { ap_none {  { sext_ln1461 in_data 0 62 } } }
	zext_ln1453_1 { ap_none {  { zext_ln1453_1 in_data 0 2 } } }
	phi_mul15231 { ap_none {  { phi_mul15231 in_data 0 16 } } }
	v596 { ap_none {  { v596 in_data 0 2 } } }
	v944 { ap_none {  { v944 in_data 0 64 } } }
	zext_ln1456 { ap_none {  { zext_ln1456 in_data 0 19 } } }
	v949 { ap_none {  { v949 in_data 0 64 } } }
	v601 { ap_none {  { v601 in_data 0 32 } } }
}
