set moduleName control_Pipeline_VITIS_LOOP_1763_5_VITIS_LOOP_1764_6
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1763_5_VITIS_LOOP_1764_6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2061 int 62 regular  }
	{ sext_ln2265 int 62 regular  }
	{ sext_ln1768 int 62 regular  }
	{ zext_ln1760_1 int 2 regular  }
	{ phi_mul15135 int 17 regular  }
	{ v721 int 2 regular  }
	{ v945 int 64 regular  }
	{ zext_ln1763 int 20 regular  }
	{ v949 int 64 regular  }
	{ v726 float 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln2265", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln1768", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1760_1", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul15135", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "v721", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "v945", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1763", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
 	{ "Name" : "v949", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v726", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln2265 sc_in sc_lv 62 signal 2 } 
	{ sext_ln1768 sc_in sc_lv 62 signal 3 } 
	{ zext_ln1760_1 sc_in sc_lv 2 signal 4 } 
	{ phi_mul15135 sc_in sc_lv 17 signal 5 } 
	{ v721 sc_in sc_lv 2 signal 6 } 
	{ v945 sc_in sc_lv 64 signal 7 } 
	{ zext_ln1763 sc_in sc_lv 20 signal 8 } 
	{ v949 sc_in sc_lv 64 signal 9 } 
	{ v726 sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2265", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2265", "role": "default" }} , 
 	{ "name": "sext_ln1768", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1768", "role": "default" }} , 
 	{ "name": "zext_ln1760_1", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln1760_1", "role": "default" }} , 
 	{ "name": "phi_mul15135", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "phi_mul15135", "role": "default" }} , 
 	{ "name": "v721", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "v721", "role": "default" }} , 
 	{ "name": "v945", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v945", "role": "default" }} , 
 	{ "name": "zext_ln1763", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "zext_ln1763", "role": "default" }} , 
 	{ "name": "v949", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v949", "role": "default" }} , 
 	{ "name": "v726", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v726", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln2265 { ap_none {  { sext_ln2265 in_data 0 62 } } }
	sext_ln1768 { ap_none {  { sext_ln1768 in_data 0 62 } } }
	zext_ln1760_1 { ap_none {  { zext_ln1760_1 in_data 0 2 } } }
	phi_mul15135 { ap_none {  { phi_mul15135 in_data 0 17 } } }
	v721 { ap_none {  { v721 in_data 0 2 } } }
	v945 { ap_none {  { v945 in_data 0 64 } } }
	zext_ln1763 { ap_none {  { zext_ln1763 in_data 0 20 } } }
	v949 { ap_none {  { v949 in_data 0 64 } } }
	v726 { ap_none {  { v726 in_data 0 32 } } }
}
