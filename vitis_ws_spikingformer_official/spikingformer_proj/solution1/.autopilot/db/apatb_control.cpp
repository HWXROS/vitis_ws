...
// wrapc file define:
#define AUTOTB_TVIN_v944 "../tv/cdatafile/c.control.autotvin_v944.dat"
#define AUTOTB_TVOUT_v944 "../tv/cdatafile/c.control.autotvout_v944.dat"
#define AUTOTB_TVIN_v945 "../tv/cdatafile/c.control.autotvin_v945.dat"
#define AUTOTB_TVOUT_v945 "../tv/cdatafile/c.control.autotvout_v945.dat"
#define AUTOTB_TVIN_v946 "../tv/cdatafile/c.control.autotvin_v946.dat"
#define AUTOTB_TVOUT_v946 "../tv/cdatafile/c.control.autotvout_v946.dat"
#define AUTOTB_TVIN_g0 "../tv/cdatafile/c.control.autotvin_g0.dat"
#define AUTOTB_TVOUT_g0 "../tv/cdatafile/c.control.autotvout_g0.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_g0 "../tv/rtldatafile/rtl.control.autotvout_g0.dat"
...
extern "C"
void control_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_control_hw(void* __xlx_apatb_param_v944, void* __xlx_apatb_param_v945, void* __xlx_apatb_param_v946)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_v944;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_v944),
#endif
  };
  port0.param = &__xlx_offset_byte_param_v944;

  static hls::sim::Byte<4> __xlx_offset_byte_param_v945;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_v945),
#endif
  };
  port1.param = &__xlx_offset_byte_param_v945;

  static hls::sim::Byte<4> __xlx_offset_byte_param_v946;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_v946),
#endif
  };
  port2.param = &__xlx_offset_byte_param_v946;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_g0),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_g0),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_g0),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_g0),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_g0),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_g0),
#endif
#endif
    .hasWrite = { true, true, true },
    .max_nbytes = { 0, 0, 0 },
  };
  port3.param = { __xlx_apatb_param_v944, __xlx_apatb_param_v945, __xlx_apatb_param_v946 };
  port3.mname = { "v944", "v945", "v946" };
  port3.nbytes = { 364756992, 364756992, 364756992 };
  ...
  __xlx_offset_byte_param_v944 = port3.offset[0]*4;
  __xlx_offset_byte_param_v945 = port3.offset[1]*4;
  __xlx_offset_byte_param_v946 = port3.offset[2]*4;
  ...
  try {
    ...
    control_hw_stub_wrapper(__xlx_apatb_param_v944, __xlx_apatb_param_v945, __xlx_apatb_param_v946);
