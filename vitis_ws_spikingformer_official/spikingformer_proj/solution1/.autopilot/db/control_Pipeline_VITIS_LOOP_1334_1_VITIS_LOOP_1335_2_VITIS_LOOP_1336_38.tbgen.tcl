set moduleName control_Pipeline_VITIS_LOOP_1334_1_VITIS_LOOP_1335_2_VITIS_LOOP_1336_38
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1334_1_VITIS_LOOP_1335_2_VITIS_LOOP_1336_38}
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "sext_ln1339", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln2061_1 sc_in sc_lv 62 signal 2 } 
	{ sext_ln2027 sc_in sc_lv 62 signal 3 } 
	{ sext_ln1339 sc_in sc_lv 62 signal 4 } 
	{ sext_ln2061 sc_in sc_lv 62 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1339", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1339", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1339 { ap_none {  { sext_ln1339 in_data 0 62 } } }
