set moduleName control_Pipeline_VITIS_LOOP_1719_1_VITIS_LOOP_1720_2_VITIS_LOOP_1721_3
set isTopModule 0
...
set cdfgNum 202
set C_modelName {control_Pipeline_VITIS_LOOP_1719_1_VITIS_LOOP_1720_2_VITIS_LOOP_1721_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ g0 int 32 regular {axi_master 2 stable }  }
	{ sext_ln2113 int 62 regular  }
	{ sext_ln2265 int 62 regular  }
	{ sext_ln2299 int 62 regular  }
	{ sext_ln2113_2 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "g0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "v944","offset": { "type": "dynamic","port_name": "v944"},"direction": "READWRITE"},{"cName": "v945","offset": { "type": "dynamic","port_name": "v945"},"direction": "READWRITE"},{"cName": "v946","offset": { "type": "dynamic","port_name": "v946"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln2113", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln2113_2", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln2113 sc_in sc_lv 62 signal 1 } 
	{ sext_ln2265 sc_in sc_lv 62 signal 2 } 
	{ sext_ln2299 sc_in sc_lv 62 signal 3 } 
	{ sext_ln2113_2 sc_in sc_lv 62 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2113", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2113", "role": "default" }} , 
 	...
 	{ "name": "sext_ln2113_2", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln2113_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "393231", "Max" : "393231"}
	, {"Name" : "Interval", "Min" : "393218", "Max" : "393218"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln2113 { ap_none {  { sext_ln2113 in_data 0 62 } } }
	sext_ln2265 { ap_none {  { sext_ln2265 in_data 0 62 } } }
	sext_ln2299 { ap_none {  { sext_ln2299 in_data 0 62 } } }
	sext_ln2113_2 { ap_none {  { sext_ln2113_2 in_data 0 62 } } }
