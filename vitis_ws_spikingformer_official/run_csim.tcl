open_project -reset spikingformer_csim_proj
set_top control
add_files hls.cpp
...
# Generated by: spikingjelly2onnx -> hca-opt -> hca-translate
set fhca_bins [pwd]/../../FastHCA/gen-mlir2hls/spikingformer_official/output/gen/bins
set csim_build [pwd]/spikingformer_csim_proj/solution1/csim/build

# Copy weights from FHCA output
file mkdir $csim_build/data
foreach f [glob -nocomplain $fhca_bins/*.bin] {
    file copy -force $f $csim_build/data/
}

# Copy test images from local dir
