...
HLS_SOURCES = ../../../../tb_spikingformer_official.cpp ../../../../spikingformer_official_original.cpp
...
$(ObjDir)/spikingformer_official_original.o: ../../../../spikingformer_official_original.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../spikingformer_official_original.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=control $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/spikingformer_official_original.d
