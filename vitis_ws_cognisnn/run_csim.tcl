open_project -reset cognisnn_csim_proj
set_top control
add_files hls.cpp
...
set fhca_bins [pwd]/../../FastHCA/gen-mlir2hls/cognisnn/output/gen/bins
set csim_build [pwd]/cognisnn_csim_proj/solution1/csim/build
